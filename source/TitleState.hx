...
class TitleState extends MusicBeatState
{
	...
	public static var mainMenuSong:String;
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			// music.loadStream(Paths.music(mainMenuSong));
			// FlxG.sound.list.add(music);
			// music.play();

			if(FlxG.sound.music == null) {
				FlxG.sound.playMusic(Paths.music(mainMenuSong), 0);
			}
		}
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['VS Veinady By'], -40);
					#else
				...
				case 8:
					#if PSYCH_WATERMARKS
					addMoreText('JTSF', -40);
					addMoreText('Cryo Frost', -40);
					addMoreText('Scratch', -40);
					addMoreText('Rivox', -40);
					addMoreText('and more! (See Credits)', -40);
					#else
